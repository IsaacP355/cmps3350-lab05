...
int main() {
    ...
    // reset TicTacToe board in case player ends up playing again
    endGame = false;
    for(int i = 0; i < 9; i++)
        choices[i] = '1' + i;
    ...
    cout << "4. Exit the Arcade" << endl;
    cout << "*******************************************" << endl;

    cout << "Enter the number of your choice ( 1, 2, 3, or 4 ): ";
    cin >> option;
    cout << endl;
    ...
    if (option == 3)
    {
        ...
        // return back to arcade after 10 seconds have passed
        cout << "---------------------------------------" << endl;
        cout <<  "RETURNING BACK TO ARCADE IN 10 SECONDS." << endl;
        cout << "---------------------------------------" << endl;
        usleep(10000000);
    ...
    else if (option == 2)
    {
        ...
        while(endGame == false) { // game will continue until the game either has a winner or no spots are available
            ...
            if(player == true) { // This is when it is Player 1's turn
                ...
                cin >> choice;
                // need to make sure player isnt choosing a spot already taken
                while(choices[choice - 1] == 'X' || choices[choice - 1] == 'O') {
                    cout << "That spot is already taken. Please enter another spot to mark: ";
                    cin >> choice;
                }
            ...
            if(DidPlayerWin() == true) { // Did either player win after their turn?
                ...
                if(player == false) // if the match is all "O"
            ...
            if(endGame == true) { 
               // return back to arcade after 10 seconds have passed
               cout << "---------------------------------------" << endl;
               cout << "RETURNING BACK TO ARCADE IN 5 SECONDS." << endl;
               cout << "---------------------------------------" << endl;
               usleep(5000000);
            }
